...
function Header () {
    ...
    return (
        ...
        <div class="menu">
            <div class="menu-item" style={{display: "flex", alignItems: "center", gap: "5px", justifyContent: "center", cursor: "pointer"}} onClick={Search}>
            ...
            <Link to={SALES} class={getMenuItemClass(SALES)}>Скидки</Link>
            <Link to={NEWESTS} class={getMenuItemClass(NEWESTS)}>Новинки</Link>
            <Link to={HOME} class={getMenuItemClass(HOME)}>Главная страница</Link>
            <Link to={ALLGOODS} class={getMenuItemClass(ALLGOODS)}>Все товары</Link>
            <div class="dropdown">
                <span class="menu-item dropdown-toggle">Категории</span>
                <div class="dropdown-menu">
                    {categories.map((category) => (
                        <Link to={`/Category/${category}`} class="dropdown-item">{category}</Link>
                    ))}
                </div>
            </div>
        </div>
        <div class="social-icons">
            <a href="https://www.instagram.com/reel/DGRUdgXv-qV/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" class="social-icon">
